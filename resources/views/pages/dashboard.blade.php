...
<div class="row">
    ...
    <div class="card">
        ...
        <div class="text-end pt-1">
            <h4 class="text-sm mb-0 text-capitalize">Total Collection for the Year</h4>
    ...
    <div class="card">
        ...
        <div class="text-end pt-1">
            <h4 class="text-sm mb-0 text-capitalize">Collection for Current Month</h4>
    ...
    <div class="card">
        ...
        <div class="text-end pt-1">
            <h4 class="text-sm mb-0 text-capitalize">Total School that Payed</h4>
    ...
    <div class="card">
        ...
        <div class="text-end pt-1">
            <h4 class="text-sm mb-0 text-capitalize">Total number of Schools</h4>
